...
The word earnings were generated on 2013-03-14, and the total word counts follow below.

Collated Word Count: 48,111
Collated Weighted Word Count: 14,433
Images: 5
Original Word Count: 177,280
Total Word Count: 225,391
Total Weighted Word Count: 191,763
...
def getSummaryText(earningsText, payoutEnd, totalTomecount):
	...
	cString.write('%s\n' % earningsText)
	cString.write('They are generated by tomecount.py:\n')
	cString.write('https://raw.github.com/Unthinkingbit/charity/master/tomecount.py\n\n')
	cString.write('The word counts for each writer are at:\n')
	cString.write('https://raw.github.com/Unthinkingbit/charity/master/tomecount.csv\n\n')
...
def getTomecountText(authors, payoutBegin, payoutEnd, totalTomecount):
...
def getTotalTomecount(authors, payoutBegin, payoutEnd):
	'Get the tomecount csv text for the authors.'
...
def writeOutput(arguments):
	...
	totalTomecount = getTotalTomecount(authors, payoutBegin, payoutEnd)
	tomecountText = getTomecountText(authors, payoutBegin, payoutEnd, totalTomecount)
	earningsText = getEarningsText(authors)
	outputSummaryTo = almoner.getParameter(arguments, 'tomecount_summary.txt', 'outputsummary')
	...
	if almoner.sendOutputTo(outputSummaryTo, getSummaryText(earningsText, payoutEnd, totalTomecount)):
